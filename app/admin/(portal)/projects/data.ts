...
export const mockProjects = [
  {
    ...
    location: 'Oakdale, NV',
    type: 'residential',
    manager: { first_name: 'Karen', last_name: 'Brooks' },
    client: { name: 'Johnson Family' },
    due_date: 'Apr 15, 2026',
    progress: 100,
    status: 'in_progress', // Using "In Progress" as shown in the screenshot for this detailed project
    image_url: 'https://images.unsplash.com/photo-1632759145355-6b5d27ffc264?w=1000&h=400&fit=crop',
    details: {
      totalBudget: 85000,
      spent: 61200,
      remaining: 23800,
  ...
  },
  {
    ...
    type: 'commercial',
    manager: { first_name: 'Derek', last_name: 'Owens' },
    client: { name: 'Metro Corp' },
    progress: 50,
    due_date: 'May 30, 2026',
    status: 'in_progress',
    image_url: 'https://images.unsplash.com/photo-1518458028785-8fbcd101ebb9?w=500&h=300&fit=crop',
  },
  {
    id: 'PRJ-003',
    ...
    type: 'residential',
    manager: { first_name: 'Karen', last_name: 'Brooks' },
    client: { name: 'Rivera LLC' },
    progress: 20,
    due_date: 'Jun 30, 2026',
    status: 'on_hold',
    image_url: 'https://images.unsplash.com/photo-1605810711744-1bb6233150cd?w=500&h=300&fit=crop',
  },
  {
    id: 'PRJ-004',
    ...
    type: 'residential',
    manager: { first_name: 'David', last_name: 'Park' },
    client: { name: 'Highland HOA' },
    progress: 100,
    due_date: 'Mar 10, 2026',
    status: 'in_progress',
    image_url: 'https://images.unsplash.com/photo-1582268611958-ebfd161ef9cf?w=500&h=300&fit=crop',
  },
  {
    id: 'PRJ-005',
    ...
    type: 'commercial',
    manager: { first_name: 'Derek', last_name: 'Owens' },
    client: { name: 'Summerlin Dev' },
    progress: 60,
    due_date: 'Feb 28, 2026',
    status: 'in_progress',
    image_url: 'https://images.unsplash.com/photo-1628114510006-21ffcc6a12df?w=500&h=300&fit=crop',
  },
  {
    id: 'PRJ-006',
  ...
  },
  {
    ...
    due_date: 'Jun 9, 2026',
    status: 'in_progress',
    image_url: 'https://images.unsplash.com/photo-1623912061214-419b45e22ee5?w=500&h=300&fit=crop',
  },
  {
    id: 'PRJ-008',
    ...
    due_date: 'Jun 9, 2026',
    status: 'on_hold',
    image_url: 'https://images.unsplash.com/photo-1512917774080-9991f1c4c750?w=500&h=300&fit=crop',
  },
  {
    id: 'PRJ-009',
    ...
    due_date: 'Jun 9, 2026',
    status: 'in_progress',
    image_url: 'https://images.unsplash.com/photo-1549517045-bc93de075e53?w=500&h=300&fit=crop',
  },
  {
    id: 'PRJ-010',
    ...
    due_date: 'Jun 9, 2026',
    status: 'on_hold',
    image_url: 'https://images.unsplash.com/photo-1481277542470-605612bd2d61?w=500&h=300&fit=crop',
  }
];
