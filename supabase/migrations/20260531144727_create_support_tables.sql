...
--
-- Guarded so the migration sequence can be replayed from scratch: the baseline
-- schema already carries these objects, so this runs as a no-op there.
-- =============================================================================
...
DROP POLICY IF EXISTS "Tickets visible to admins/managers" ON support_tickets;
...
DROP POLICY IF EXISTS "Tickets visible to clients" ON support_tickets;
...
DROP POLICY IF EXISTS "Tickets updatable by admins/managers" ON support_tickets;
...
DROP POLICY IF EXISTS "Tickets insertable by clients" ON support_tickets;
...
DROP POLICY IF EXISTS "Messages visible to ticket viewers" ON support_messages;
...
DROP POLICY IF EXISTS "Messages insertable by participants" ON support_messages;
